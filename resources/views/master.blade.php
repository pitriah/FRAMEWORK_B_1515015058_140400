...
<body>
        ...
        <div class="container">
            ...
            <div class="container">
                <div class="content">
                    <div class="title" style="color: grey">Praktikum Pemrograman Framework<br>
                    Pitriah 1515015058</div>
                    </div>
                </div>
            <div>
            ...
            <nav class="navbar navbar-default navbar-fixed-bottom">
                <footer class="container">
                    created by <a href="#"><span><i class="fa fa-twitter" style"color#1da1f2"></i>@pitriah</span></a>
                </footer>
            </nav>
